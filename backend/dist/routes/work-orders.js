...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const { type, priority, vehicle_id, driver_id, unit, workshop_name, workshop_type, responsible, origin, description, diagnosis, notes, opened_at, estimated_at, km_opening, cost_labor, cost_towing, cost_others } = req.body;
...
router.put('/:id', async (req, res) => {
    try {
        const { id } = req.params;
        const { type, priority, vehicle_id, driver_id, unit, workshop_name, workshop_type, responsible, origin, description, diagnosis, notes, opened_at, estimated_at, closed_at, km_opening, km_closing, cost_parts, cost_labor, cost_towing, cost_others } = req.body;
        const result = await pool.query(`
